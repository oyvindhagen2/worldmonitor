...
export interface StockExchange {
  ...
  timezone?: string;
  description?: string;
  indices?: Array<{ symbol: string; name: string; display: string }>; // Primary indices
}
...
export const STOCK_EXCHANGES: StockExchange[] = [
  ...
  { id: 'sse', name: 'Shanghai Stock Exchange', shortName: 'SSE', city: 'Shanghai', country: 'CN', lat: 31.2333, lon: 121.4865, tier: 'mega', marketCap: 7.4, tradingHours: '09:30-15:00 CST', timezone: 'Asia/Shanghai', description: 'Largest exchange in China', indices: [{ symbol: '^SSEC', name: 'Shanghai Composite', display: 'SSEC' }] },
  { id: 'euronext', name: 'Euronext', shortName: 'Euronext', city: 'Amsterdam', country: 'NL', lat: 52.3465, lon: 4.8790, tier: 'mega', marketCap: 7.2, tradingHours: '09:00-17:30 CET', timezone: 'Europe/Amsterdam', description: 'Pan-European exchange', indices: [{ symbol: '^FCHI', name: 'CAC 40', display: 'CAC' }, { symbol: '^STOXX50E', name: 'Euro Stoxx 50', display: 'STOXX50' }, { symbol: '^AEX', name: 'AEX', display: 'AEX' }] },
  { id: 'jpx', name: 'Japan Exchange Group', shortName: 'JPX/TSE', city: 'Tokyo', country: 'JP', lat: 35.6803, lon: 139.7717, tier: 'mega', marketCap: 6.5, tradingHours: '09:00-15:00 JST', timezone: 'Asia/Tokyo', description: 'Tokyo Stock Exchange', indices: [{ symbol: '^N225', name: 'Nikkei 225', display: 'N225' }] },
  ...
  { id: 'hkex', name: 'Hong Kong Stock Exchange', shortName: 'HKEX', city: 'Hong Kong', country: 'HK', lat: 22.2832, lon: 114.1569, tier: 'major', marketCap: 4.5, tradingHours: '09:30-16:00 HKT', timezone: 'Asia/Hong_Kong', description: 'Gateway to Chinese markets', indices: [{ symbol: '^HSI', name: 'Hang Seng', display: 'HSI' }] },
  { id: 'lse', name: 'London Stock Exchange', shortName: 'LSE', city: 'London', country: 'GB', lat: 51.5155, lon: -0.0922, tier: 'major', marketCap: 3.4, tradingHours: '08:00-16:30 GMT', timezone: 'Europe/London', description: 'Europe\'s largest exchange', indices: [{ symbol: '^FTSE', name: 'FTSE 100', display: 'FTSE' }] },
  { id: 'nse-india', name: 'National Stock Exchange of India', shortName: 'NSE', city: 'Mumbai', country: 'IN', lat: 19.0557, lon: 72.8525, tier: 'major', marketCap: 3.6, tradingHours: '09:15-15:30 IST', timezone: 'Asia/Kolkata', description: 'India\'s largest exchange by volume', indices: [{ symbol: '^NSEI', name: 'Nifty 50', display: 'NIFTY' }] },
  { id: 'bse-india', name: 'BSE (Bombay Stock Exchange)', shortName: 'BSE', city: 'Mumbai', country: 'IN', lat: 18.9281, lon: 72.8333, tier: 'major', marketCap: 3.4, tradingHours: '09:15-15:30 IST', timezone: 'Asia/Kolkata', description: 'Asia\'s oldest exchange', indices: [{ symbol: '^BSESN', name: 'Sensex', display: 'SENSEX' }] },
  ...
  { id: 'krx', name: 'Korea Exchange', shortName: 'KRX', city: 'Seoul', country: 'KR', lat: 37.5230, lon: 126.9258, tier: 'major', marketCap: 2.2, tradingHours: '09:00-15:30 KST', timezone: 'Asia/Seoul', description: 'South Korea\'s exchange', indices: [{ symbol: '^KS11', name: 'KOSPI', display: 'KOSPI' }] },
  { id: 'six', name: 'SIX Swiss Exchange', shortName: 'SIX', city: 'Zurich', country: 'CH', lat: 47.3685, lon: 8.5400, tier: 'major', marketCap: 2.0, tradingHours: '09:00-17:30 CET', timezone: 'Europe/Zurich', description: 'Switzerland\'s primary exchange', indices: [{ symbol: '^SSMI', name: 'SMI', display: 'SMI' }] },
  { id: 'asx', name: 'Australian Securities Exchange', shortName: 'ASX', city: 'Sydney', country: 'AU', lat: -33.8672, lon: 151.2067, tier: 'major', marketCap: 1.7, tradingHours: '10:00-16:00 AEST', timezone: 'Australia/Sydney', description: 'Australia\'s primary exchange', indices: [{ symbol: '^AXJO', name: 'ASX 200', display: 'ASX' }] },
  { id: 'xetra', name: 'Deutsche Börse (Xetra)', shortName: 'Xetra', city: 'Frankfurt', country: 'DE', lat: 50.1110, lon: 8.6804, tier: 'major', marketCap: 2.3, tradingHours: '09:00-17:30 CET', timezone: 'Europe/Berlin', description: 'Germany\'s primary exchange', indices: [{ symbol: '^GDAXI', name: 'DAX 40', display: 'DAX' }] },
  { id: 'twse', name: 'Taiwan Stock Exchange', shortName: 'TWSE', city: 'Taipei', country: 'TW', lat: 25.0388, lon: 121.5632, tier: 'major', marketCap: 2.0, tradingHours: '09:00-13:30 CST', timezone: 'Asia/Taipei', description: 'Taiwan\'s primary exchange', indices: [{ symbol: '^TWII', name: 'TWSE', display: 'TWSE' }] },
  { id: 'oslo', name: 'Oslo Stock Exchange', shortName: 'OSEBX', city: 'Oslo', country: 'NO', lat: 59.9139, lon: 10.7522, tier: 'major', marketCap: 1.0, tradingHours: '09:00-17:30 CET', timezone: 'Europe/Oslo', description: 'Norway\'s primary exchange', indices: [{ symbol: '^OSLO', name: 'OSEBX', display: 'OSEBX' }] },
